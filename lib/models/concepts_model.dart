class ConceptsModel {
  ...
  ConceptsModel({this.data, this.links, this.meta});

  ConceptsModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    contentType = json['content_type'] != null
        ? ContentType.fromJson(json['content_type'])
        : null;
  }
...
class Subject {
  ...
  Subject({this.id, this.name, this.description, this.image, this.video});
...
class ContentType {
  ...
  ContentType({this.id, this.type, this.name});
