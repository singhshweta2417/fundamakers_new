...
class _EditScreenState extends State<EditScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final viewProfile = Provider.of<UserDetailViewModel>(context, listen: false);
      viewProfile.getUserDetailsApi(context);

      if (viewProfile.userDetailsResponse?.data!= null){
        firstNameCon.text=viewProfile.userDetailsResponse!.data!.firstName.toString();
        lastNameCon.text=viewProfile.userDetailsResponse!.data!.lastName.toString();
        whatsAppNumberCon.text=viewProfile.userDetailsResponse!.data!.mobileNumber.toString();
      }else{
        print('jojoj');
      }
    });
      ...
      body: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              DropdownMenu<String>(
                ...
                initialSelection: list.isNotEmpty ? list.first.name ?? '' : '',
              ...
              DropdownMenu<String>(
                ...
                dropdownMenuEntries: listTwo
                    .map<DropdownMenuEntry<String>>((SubCourseModel subCourse) {
                  return DropdownMenuEntry<String>(
          ...
          AppBtn(
            ...
            onTap: () {
              userDetailUpdate.userDetailsApi(firstNameCon.text.toString(),
                  lastNameCon.text.toString(), context);
            },
            title: 'Submit',
          ),
        ],
