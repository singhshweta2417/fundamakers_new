...
class _GkZoneScreenState extends State<GkZoneScreen> {
  ...
  GkZoneProvider gkZoneProvider = GkZoneProvider();

  List<GkZoneModel> gkZoneList = [];
  bool isLoading = false;

  Future<void> allGkZoneData() async {
    gkZoneList.clear();
    try {
      setState(() {
        isLoading = true;
      });
      List<GkZoneModel> reviewsList = await gkZoneProvider.fetchGkZoneData();
      setState(() {
        gkZoneList = reviewsList;
        isLoading = false;
      });
    } catch (e) {
      setState(() {
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
          builder:  (BuildContext context, BoxConstraints constraints)  {
            ...
            return
              gkZoneList.isEmpty?const Center(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                gkZoneList[index].fileName.toString(),
                                maxLines: 1,
                              ...
                              Text(
                                gkZoneList[index].uniqueName.toString(),
                                style: GoogleFonts.robotoCondensed(
                                  textStyle: const TextStyle(
                                    color: Colors.black,
