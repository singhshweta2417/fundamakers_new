...
import 'package:fundamakers/view/app/community/post_question/bottomsheet.dart';
import 'package:fundamakers/view/app/community/post_question/create_poll.dart';
import 'package:fundamakers/view/app/community/post_question/post_screen.dart';
...
class _CommunityPostScreenState extends State<CommunityPostScreen> {
  ...
  Widget showPopUp(BuildContext context) {
    return Dialog(
      ...
      child: SizedBox(
        height:isTablet(context)?height * 0.15:height * 0.15,
        width:isTablet(context)?width * 0.3:width * 0.3,
        child: Column(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
            const Text(
              ...
              child: Row(
                ...
                children: [
                  AppBtn(
                    ...
                    width:isTablet(context)?MediaQuery.of(context).size.width * 0.1:MediaQuery.of(context).size.width * 0.25,
                    title: 'Create Post',
                  ),
                  SizedBox(
                    width: width * 0.026,
