...
class GkPdfScreen extends StatefulWidget {
  const GkPdfScreen({Key? key}) : super(key: key);

  @override
  State<GkPdfScreen> createState() => _GkPdfScreenState();
}

class _GkPdfScreenState extends State<GkPdfScreen> {
  @override
  void initState() {
    super.initState();
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final pdfUrl ='${gkZoneList[index].host}${gkZoneList[index].filePath}${gkZoneList[index].uniqueName}';
