...
class _ClassHandOutsScreenState extends State<ClassHandOutsScreen> {
  ...
  HanOutsProvider hanOutsProvider = HanOutsProvider();

  List<ClassHangOutsModel> classHangOutsList = [];
  bool isLoading = false;

  Future<void> allHandOutsData() async {
    classHangOutsList.clear();
    try {
      setState(() {
        isLoading = true;
      });
      List<ClassHangOutsModel> reviewsList = await hanOutsProvider.fetchClassHandOutsData();
      setState(() {
        classHangOutsList = reviewsList;
        isLoading = false;
      });
    } catch (e) {
      setState(() {
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
          builder:  (BuildContext context, BoxConstraints constraints)  {
            ...
            return
              classHangOutsList.isEmpty?const Center(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              classHangOutsList[index].fileName.toString(),
                              maxLines: 1,
                            ...
                            Text(
                              classHangOutsList[index].description.toString(),
                              maxLines: 1,
                              style: GoogleFonts.robotoCondensed(
                                textStyle: const TextStyle(
                                  color: Colors.black,
                            ...
                            Text(
                              classHangOutsList[index].uniqueName.toString(),
                              style: GoogleFonts.robotoCondensed(
                                textStyle: const TextStyle(
                                  color: Colors.black,
